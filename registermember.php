					...
					<div class="blankpage-main col-md-12">
						...
						<div class="login-block col-md-8 " style="height:auto; margin: 0 auto; align:center;">
							<form method="POST" action="postregister.php">
								...
								<input type="text" name="nationalId" placeholder="National Id/ Passport No." required="">
								<input type="text" name="email" placeholder="Email" required="">
								<input type="text" name="mobile" placeholder="Mobile" required="">
								<input type="text" name="memberId" placeholder="Sacco Id" required="">
								...
								<a href="#" id="example-show" style="text-decoration: none; color: #36f; padding-left: 8px; background: transparent url(down.gif) no-repeat left;" class="showLink" onclick="showHide('example');return false;">Add next of kin (optional).</a></p>
								<div id="example" class="more" style="display: none; border-top: 1px solid rgb(104, 174, 0); border-bottom: 1px solid rgb(104, 174, 0);"><br>
									<h4 style="color: rgb(104, 174, 0);">Next of Kin Details</h4>
									<input type="text" name="kin_fname" placeholder="Kin's First Name">
									<input type="text" name="kin_mname" placeholder="Kin's Middle Name">
									<input type="text" name="kin_lname" placeholder="Kin's Last Name">
									<input type="text" name="kin_NId" placeholder="Kin's National Id/ Passport No.">
									<input type="text" name="kin_email" placeholder="Kin's Email">
									<input type="text" name="kin_mobile" placeholder="Kin's Mobile">
									<input type="text" name="kin_occupation" placeholder="Kin's Occupation">
									...
									<div class="forgot-grid">
										<ul>
											...
											<li>
												<label for="select"><span></span>Kin's Date of birth</label>
												<select id="select" name="kin_day"  style="color:#8C8C8C">
													<option selected="selected" value="">Day</option>
													<option style="color:#FC8213" value="1">1</option>
													<option style="color:#FC8213" value="2">2</option>
													<option style="color:#FC8213" value="3">3</option>
												...
												<select id="select" name="kin_month"  style="color:#8C8C8C">
													<option selected="selected" value="">Month</option>
													<option style="color:#FC8213" value="1">January</option>
													<option style="color:#FC8213" value="2">February</option>
													<option style="color:#FC8213" value="3">March</option>
											...
											<li>
												<select id="select" name="kin_year"  style="color:#8C8C8C; margin-right:20px;">
													<option selected="selected" value="">Year</option>
													<option style="color:#FC8213" value="2020">2020</option>
													<option style="color:#FC8213" value="2019">2019</option>
													<option style="color:#FC8213" value="2018">2018</option>
											...
											<li>
												<label for="select" ><span></span>Kin's Gender</label>
												<select id="select" name="kin_gender"  style="color:#8C8C8C; margin-left:40px">
													<option selected="selected" value="">Select Gender</option>
													<option style="color:#FC8213" value="male">Male</option>
													<option style="color:#FC8213" value="female">Female</option>
												</select>
									...
									<p><a href="#" id="example-hide" style="" class="hideLink" onclick="showHide('example');return false;">Hide this content.</a></p>
								</div>
